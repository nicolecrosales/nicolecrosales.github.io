const apiURL = 'https://api.openweathermap.org/data/2.5/weather?id=5607916&units=imperial&appid=fd15d96290be857f5672c4e23645f6bb';
...
fetch(apiURL)
        ...
        fetch("https://api.openweathermap.org/data/2.5/forecast?id=5607916&units=imperial&appid=12f91a41bd21c1ca9341109b7e228eab")
        .then((response) => response.json())
        .then((jsObject) =>{
